...
import PrivacyPolicyTOC from './PrivacyPolicyTOC';
...
export default function PrivacyPolicyPage() {
  ...
  useGSAP(() => {
    ...
    const fadeElements = containerRef.current?.querySelectorAll('.legal-body h2, .legal-body h3, .legal-body p, .legal-body ul, .legal-body table, .legal-body .callout');
      ...
      <section className="pt-32 pb-16 relative">
        <div className="max-w-5xl mx-auto px-8">
          ...
          <p className="text-lg font-light text-gray-700 max-w-2xl leading-relaxed">
            ...
            Your organizational data processed by our platform never leaves your infrastructure.
          </p>
