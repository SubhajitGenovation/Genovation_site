    ...
    <footer className="py-16 border-t border-black/[0.06]">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            <div className="text-[11px] text-gray-500 font-mono tracking-wider uppercase mb-4">Research</div>
            <div className="space-y-2.5">
              {["Explainability", "Efficient LMs", "Privacy Analytics", "Cryptography"].map((item) => (
                <a key={item} href="#" className="block text-[13px] text-gray-500 hover:text-gray-700 font-light transition-colors">{item}</a>
              ))}
            </div>
          </div>
