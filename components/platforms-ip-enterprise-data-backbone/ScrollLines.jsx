...
export default function ScrollLines() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen pointer-events-none z-0 overflow-visible" aria-hidden="true">
      <div id="sLine1" className="absolute top-0 left-0 w-full" style={{ height: "1000vh" }}>
        <svg viewBox="0 0 1440 10000" preserveAspectRatio="none" fill="none" className="w-full h-full">
          <defs>
      ...
      <div id="sLine2" className="absolute top-0 left-0 w-full" style={{ height: "1000vh" }}>
        <svg viewBox="0 0 1440 10000" preserveAspectRatio="none" fill="none" className="w-full h-full">
          <defs>
      ...
      <div id="sLine3" className="absolute top-0 left-0 w-full" style={{ height: "1000vh" }}>
        <svg viewBox="0 0 1440 10000" preserveAspectRatio="none" fill="none" className="w-full h-full">
          <defs>
