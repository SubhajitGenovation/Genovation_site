...
export default function CompanyPanel() {
  return (
    <div className="pt-0 pb-6">
      <div className="grid grid-cols-[3fr_3fr_2.5fr_4.5fr] gap-0 px-0 py-9">
        ...
        <div className="px-8 border-r border-gray-100">
        ...
        <div className="pl-8">
          ...
          <div className="grid grid-cols-2 gap-4 mb-5">
            ...
            >
              ...
              <Icon
                name="chevron-right"
                className="w-3.5 h-3.5 absolute right-3 bottom-3 text-gray-400 opacity-0 -translate-x-1 transition-all duration-250 group-hover:opacity-100 group-hover:translate-x-0 group-hover:text-emerald-500"
              />
            </Link>
            <Link
