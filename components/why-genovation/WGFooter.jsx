...
export default function WGFooter() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-[13px] text-gray-500 font-light leading-relaxed max-w-xs">
              Sovereign enterprise intelligence. Your data, your
          ...
          {/* Platform */}
          <div>
            <div className="text-[11px] text-gray-500 font-mono tracking-wider uppercase mb-4">
              Platform
            </div>
            <div className="space-y-2.5">
              {["Mentis AgentOS", "Data Backbone", "CipherVault", "JUDGE"].map(
                (item) => (
                  <a
                    key={item}
                    href="#"
                    className="block text-[13px] text-gray-500 hover:text-gray-700 font-light transition-colors"
                  >
                    {item}
                  </a>
                )
        ...
        <div className="border-t border-black/[0.04] pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-500 font-light">
            © 2026 Genovation. All rights reserved.
          </p>
