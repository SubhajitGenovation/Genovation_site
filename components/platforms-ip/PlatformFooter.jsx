    ...
    <footer className="py-16 border-t border-black/[0.06]">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          {[["Platform", platform], ["Products", products], ["Company", company]].map(([heading, items]) => (
            <div key={heading}>
              <div className="text-[11px] text-gray-500 font-mono tracking-wider uppercase mb-4">{heading}</div>
